          ...
          {selectedOrder && (
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              <Box>
                ...
                <Typography variant="body1">{selectedOrder.bleach}</Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2" color="textSecondary">
                  Sử dụng túi:
                </Typography>
                <Typography variant="body1">{selectedOrder.useBag}</Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2" color="textSecondary">
                  Giặt khô:
                ...
                <Typography variant="body1">
                  {selectedOrder.dryCleaningItems ? "Có" : "Không"}
                </Typography>
              </Box>
              <Box>
                <Typography variant="subtitle2" color="textSecondary">
      ...
      >
        ...
        <DialogContent>
          <Typography>
            ...
            {orderToDelete?._id?.substring(orderToDelete._id.length - 6)} của
            khách hàng {orderToDelete?.name}?
          </Typography>
        </DialogContent>
        <DialogActions>
